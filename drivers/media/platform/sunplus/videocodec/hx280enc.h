...
/*
  ...
  */
#define HX280ENC_IOCGHWOFFSET       _IOR(HX280ENC_IOC_MAGIC, 3, unsigned int)
...
#define HX280ENC_IOCXVIRT2BUS       _IOWR(HX280ENC_IOC_MAGIC, 7, unsigned int)

#define HX280ENC_IOCHARDRESET       _IO(HX280ENC_IOC_MAGIC, 8) /* debugging tool */
#define HX280ENC_IOCGSRAMOFFSET     _IOR(HX280ENC_IOC_MAGIC, 9, unsigned int)
