...
/*
 * Sunplus SP7350 SoC Display driver for OSD layer palette
 *
 * Author: Hammer Hsieh <hammer.hsieh@sunplus.com>
 */
#ifndef __SP7350_DISP_PALETTE_H__
#define __SP7350_DISP_PALETTE_H__
...
#endif	//__SP7350_DISP_PALETTE_H__
