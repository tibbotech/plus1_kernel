 ...
 *                         G L O B A L    D A T A                         *
 **************************************************************************/
static struct DISP_DMIX_REG_t *pDMIXReg;
...
{
	pDMIXReg = (struct DISP_DMIX_REG_t *)pInReg;
...
enum DRV_Status_t DRV_DMIX_PTG_ColorBar(enum DRV_DMIX_TPG_t tpg_sel, int bg_color_yuv, int border_len)
{
...
enum DRV_Status_t DRV_DMIX_Layer_Init(enum DRV_DMIX_LayerId_t Layer, enum DRV_DMIX_LayerMode_t LayerMode, enum DRV_DMIX_InputSel_t FG_Sel)
{
...
enum DRV_Status_t DRV_DMIX_Layer_Set(enum DRV_DMIX_LayerMode_t LayerMode, enum DRV_DMIX_InputSel_t FG_Sel)
{
	unsigned int tmp;
...
{
	unsigned int tmp, tmp1, tmp2, test;
