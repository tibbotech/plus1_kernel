/*
 * The OCOTP driver for Sunplus I143
 *
...
/*
 * I143 OTP memory contains 8 banks with 4 32-bit words. Bank 0 starts
...
static int sp_ocotp_probe(struct platform_device *pdev)
{
	...
	dev_dbg( dev, "clk:%ld banks:%d x wpb:%d x wsize:%lu = %lu",
...
MODULE_DESCRIPTION("Sunplus I143 OCOTP driver");
