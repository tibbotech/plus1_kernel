...
static const struct of_device_id sp_cbdma_of_ids[] = {
	{ .compatible = "sunplus,q645-cbdma", .data = &axidma_config },
	{ .compatible = "sunplus,q645-c-cbdma", .data = &axicdma_config },
	{ .compatible = "sunplus,q645-v-cbdma", .data = &axivdma_config },
	{ /* sentinel */ }
};
...
static int sp_cbdma_probe(struct platform_device *pdev)
{
	...
	// This variable is used for VDMA. Need to be confirmed!!
	num_frames = 0;
