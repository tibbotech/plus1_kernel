...
static struct sp_clk sp_clks[] = {
	...
	_(DDRCTL),
	_(I2CM0),
	_(SPI_COMBO_0,	0,	0,	0, {"f_600m"}),
	_(SPI_COMBO_1,	0,	0,	0, {"f_600m"}),
	_(SPI_COMBO_2,	0,	0,	0, {"f_600m"}),
	_(SPI_COMBO_3,	0,	0,	0, {"f_600m"}),
	_(SPI_COMBO_4,	0,	0,	0, {"f_600m"}),

	_(SPI_COMBO_5,	0,	0,	0, {"f_600m"}),
