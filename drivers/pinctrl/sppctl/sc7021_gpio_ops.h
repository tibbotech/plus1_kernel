...
#ifndef SC7021_GPIO_OPS_H
#define SC7021_GPIO_OPS_H
...
// set (I|O)inv
int sc7021gpio_u_siinv( struct gpio_chip *_c, unsigned int _n);
int sc7021gpio_u_soinv( struct gpio_chip *_c, unsigned int _n);
