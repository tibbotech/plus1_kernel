...
int sc7021gpio_f_gdi( struct gpio_chip *_c, unsigned _n);

// --- not in callbacks

// who is first: GPIO(1) | MUX(0)
int sc7021gpio_u_gfrst( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
...
void sc7021gpio_u_siinv( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
 u16 inv_off = SC7021_GPIO_OFF_IINV;
 ...
 return;  }
void sc7021gpio_u_soinv( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
 u16 inv_off = SC7021_GPIO_OFF_OINV;
 r = (BIT(R16_BOF(_n))<<16) | BIT(R16_BOF(_n));
 writel( r, pc->base1 + inv_off + R16_ROF(_n));
 return;  }

// is open-drain: YES(1) | NON(0)
int sc7021gpio_u_isodr( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
...
void sc7021gpio_f_fre( struct gpio_chip *_c, unsigned _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
...
int sc7021gpio_f_sin( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
 r = (BIT(R16_BOF(_n))<<16);
...
int sc7021gpio_f_sou( struct gpio_chip *_c, unsigned int _n, int _v) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
 r = (BIT(R16_BOF(_n))<<16) | BIT(R16_BOF(_n));
 writel( r, pc->base0 + SC7021_GPIO_OFF_OE + R16_ROF(_n));
...
int sc7021gpio_f_get( struct gpio_chip *_c, unsigned int _n) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
...
void sc7021gpio_f_set( struct gpio_chip *_c, unsigned int _n, int _v) {
 u32 r;
 sc7021gpio_chip_t *pc = ( sc7021gpio_chip_t *)gpiochip_get_data( _c);
 ...
 // FIX: test in-depth
int sc7021gpio_f_scf( struct gpio_chip *_c, unsigned _n, unsigned long _conf) {
 u32 r;
 int ret = 0;
...
void sc7021gpio_f_dsh( struct seq_file *_s, struct gpio_chip *_c) {
 int i;
 const char *label;
