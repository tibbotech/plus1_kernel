...
#ifdef CONFIG_IPIPE
IPIPE_DEFINE_SPINLOCK(gpc_psci_lock);
#else
...
static void _imx_gpc_psci_irq_unmask(struct irq_data *d)
{
	struct arm_smccc_res res;
...
static void _imx_gpc_psci_irq_mask(struct irq_data *d)
{
	struct arm_smccc_res res;
