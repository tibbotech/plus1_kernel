...
#if defined(CONFIG_MACH_PENTAGRAM_SP7021_ACHIP) || defined(CONFIG_MACH_PENTAGRAM_SP7021_BCHIP) || defined(CONFIG_SOC_I143)
#define SUPPORT_IRQ_GRP_REG
#endif

#define dprn(...)            /* empty */
//#define dprn(fmt, arg...)  printk(fmt, ##arg)
