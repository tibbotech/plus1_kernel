...
static void imx_irqsteer_irq_unmask(struct irq_data *d)
{
	...
	raw_spin_lock_irqsave(&irqsteer_data->lock, flags);
	...
	raw_spin_unlock_irqrestore(&irqsteer_data->lock, flags);
}
...
#ifdef CONFIG_IPIPE
	.irq_mask_ack	= imx_irqsteer_irq_mask,
#endif /* CONFIG_IPIPE */
	.irq_unmask	= imx_irqsteer_irq_unmask,
	.irq_ack	= imx_irqsteer_irq_ack,
#ifdef CONFIG_IPIPE
	.irq_hold		= imx_irqsteer_irq_mask,
	.irq_release	= imx_irqsteer_irq_unmask,
#endif	
