...
static void sp_clockevent_init(void)
{
	...
	BUG_ON(!sp_timer_irqs[SP_TIMER_STC_TIMER3]);

	sp_clockevent_dev_timer3.irq = sp_timer_irqs[SP_TIMER_STC_TIMER3];
...
#error Unexpected STC frequency
	...
	ret = request_irq(sp_clockevent_dev_timer3.irq, sp_stc_timer3_isr,
